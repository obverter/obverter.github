...
<img src="{{site.baseurl | prepend: site.url}}portrait-1.png" alt="Crimes Against Portraiture, Fig. 1" />

 and compare it to this one from just now:

<img src="{{site.baseurl | prepend: site.url}}portrait-2.png" alt="Crimes Against Portraiture, Fig. 2" />
